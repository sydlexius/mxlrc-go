...
If any lint errors: print them, stop, and say:
...
Launch the following review agents against the PR-wide diff (`git diff "$(git merge-base main HEAD)"..HEAD`), in parallel:
